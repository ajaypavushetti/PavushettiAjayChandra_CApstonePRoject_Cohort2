...
function renderCakes() {
  const maxVal = parseFloat(document.getElementById('priceToggleBar').value) || 1000;
...
function renderBasket(basket) {
  ...
  if (document.getElementById('modalSubtotal')) document.getElementById('modalSubtotal').textContent = `₹${subtotal.toFixed(2)}`;
  if (document.getElementById('modalTax')) document.getElementById('modalTax').textContent = `₹${tax.toFixed(2)}`;
  if (document.getElementById('modalDeliveryFee')) document.getElementById('modalDeliveryFee').textContent = deliveryFee === 0 ? 'FREE (₹0.00)' : `₹${deliveryFee.toFixed(2)}`;
  document.getElementById('modalPayableAmount').textContent = `₹${grandTotal.toFixed(2)}`;
